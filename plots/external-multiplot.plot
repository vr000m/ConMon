...
plot "../logs/time_list.txt" using ($1-timeoffset):($37/125) title 'Total' with points lw 1 lt -1 lc -1 pt 1
...
plot "../logs/time_list.txt" using ($1-timeoffset):($39/125) title 'Total' with points lw 1 lt -1 lc -1 pt 1
...
plot "../logs/time_list.txt" using ($1-timeoffset):($41/125) title 'Total' with points lw 1 lt -1 lc -1 pt 1
...
plot "../logs/time_list.txt" using ($1-timeoffset):($43/125) title 'Cross' with points lw 1 lt -1 lc -1 pt 1
